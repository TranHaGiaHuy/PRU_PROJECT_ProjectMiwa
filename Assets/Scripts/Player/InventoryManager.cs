...
public class InventoryManager : MonoBehaviour
{
    ...
    public void LevelUpWeapon(int slotIndex,int upgradeIndex)
    {
        if (weaponSlots.Count > slotIndex)
        {
            ...
            upgradedWeapon.transform.parent = transform;// set weapon to be child of player
    ...
    public void LevelUpPassiveItem(int slotIndex, int upgradeIndex)
    {
        if (passiveitemSlots.Count > slotIndex)
        {
            ...
            upgradedPassiveItem.transform.parent = transform;// set passive item to be child of player
    ...
    {
        if (weaponnIndex >= weaponSlots.Count - 1)
        {
            return;
        }
        ...
        AddWeapon(weaponnIndex, spawnedWeapon.GetComponent<WeaponController>());
        weaponnIndex++;
    }
