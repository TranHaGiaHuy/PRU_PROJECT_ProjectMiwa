...
public class GameManager : MonoBehaviour
{
   ...
   public enum GameState
    ...
    public TMP_Text currentCollectRangeDisplay;
    ...
    public void AssignChosenWeaponsAndItemsUI(List<PlayerInventory.Slot> chosenWeaponsData, List<PlayerInventory.Slot> chosenPassiveItemsData)
    {
